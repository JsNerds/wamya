                                            ...
                                            <div className="col-lg-3 col-md-6">
                                                ...
                                                <a href="index.html" className="f-logo"><img src={require('../../assets/images/WaymyaLogoBlue.png')} alt=""/></a>
                                                    <div className="widget-wrap">
                                                        <p className="f_400 f_p f_size_15 mb-0 l_height34"><span>Email:</span> <a href="mailto:saasland@gmail.com" className="f_400">wamyatn11@gmail.com</a></p>
                                                        <p className="f_400 f_p f_size_15 mb-0 l_height34"><span>Phone:</span> <a href="tel:948256347968" className="f_400">+216 20 566 666</a></p>
                                                    </div>
