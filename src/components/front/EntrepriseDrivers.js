...
import Teamitem from '../../componentsFront/Team/Teamitem';
const EntrepriseDrivers =()=>{
    return(
        <section className="experts_team_area sec_pad">
            <div className="container">
                <Sectitle sClass="sec_title text-center mb_70" Title="Drivers" tClass="t_color3" TitleP="Why I say old chap that is spiffing barney, nancy boy bleeder chimney pot richard cheers the little rotter.!"/>
                <div className="row">
...
export default EntrepriseDrivers;