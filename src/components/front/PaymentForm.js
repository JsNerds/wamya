...
const PaymentForm = (props) => {
  ...
  const getmile = async () => {
    try {
      ...
      console.log("houni" + userPosts.data);
    } catch (err) {
      console.error(err.message);
    }
  };
        ...
        if (response.data.success) {
          ...
          if (userType === "Company") {
            const [res, err] = await queryServerApi(
              "payments/addPaymentEntrep/" + idUser,
              newVal,
              "POST",
              false
            );
  ...
  const ratingChanged = (newRating) => {
    setRating(newRating);
    getmile(Deliv.driver);
    console.log("hedhi mile" + mile?.rating);
    console.log("state" + Deliv.state);
  };
  const GotoFeedback = async (iddeliv, rate, iddriver) => {
    console.log("driver" + Deliv.driver);
    console.log("mile" + mile?._id);

    const [res, err] = await queryServerApi(
      "delivery/setfifth/" + iddeliv,
      null,
      "PUT",
      false
    );
    const [res1, err1] = await queryServerApi(
      "deliveryman/setrating/" + iddriver + "/" + rate,
      null,
      "GET",
      false
    );
                ...
                {!success ? (
                  ...
                  >
                    ...
                    {!formik.isValid && (
                      <MuiAlert className="mb-4" severity="error">
                        <div className="d-flex align-items-center align-content-center">
                          <span>
                            <strong className="d-block">Danger!</strong> Check
                            out the form again
                          </span>
                        </div>
                      </MuiAlert>
                    ...
                    <label className="f_p text_c f_400">Billing Details</label>
                    <hr />
                    ...
                    <div className="form-group text_box">
                      ...
                      {formik.errors.NameOnCard &&
                        formik.touched.NameOnCard && (
                          <FormHelperText error={formik.errors.NameOnCard}>
                            {formik.errors.NameOnCard}
                          </FormHelperText>
                        )}
                    </div>
                    ...
                    <div className="form-group text_box">
                      ...
                      {formik.errors.PhoneNumber &&
                        formik.touched.PhoneNumber && (
                          <FormHelperText error={formik.errors.PhoneNumber}>
                            {formik.errors.PhoneNumber}
                          </FormHelperText>
                        )}
                    </div>
                    ...
                    <div className="form-group text_box">
                      ...
                      <div className="form-group text_box">
                        ...
                        {formik.errors.Street && formik.touched.Street && (
                          <FormHelperText error={formik.errors.Street}>
                      ...
                      <div className="form-group text_box">
                        ...
                        {formik.errors.City && formik.touched.City && (
                          <FormHelperText error={formik.errors.City}>
                            {formik.errors.City}
                          </FormHelperText>
                        )}
                      </div>
                      ...
                      <div className="form-group text_box">
                        ...
                        {formik.errors.ZipCode && formik.touched.ZipCode && (
                          <FormHelperText error={formik.errors.ZipCode}>
                  ...
                  <>
                    <MuiAlert className="mb-4" severity="success">
                      <div className="d-flex align-items-center align-content-center">
                        <span>
                          <strong className="d-block">Success!</strong> Your
                          payment was successful! <br /> you'll receive an{" "}
                          <strong>EMAIL</strong> with more details of your
                          payment and <strong>SMS</strong> with more details of
                          your delivery
                          <br />
                          Thank you !
                        </span>
                  ...
                  <>
                    <MuiAlert className="mb-4" severity="success">
                      <div className="d-flex align-items-center align-content-center">
                        <span>
                          <strong className="d-block">Success!</strong> Your
                          payment was successful! you'll receive an EMAIL with
                          more details of your payment
                        </span>
                        <br />
                      </div>
                    </MuiAlert>
                      ...
                      <div className="d-flex align-items-center align-content-center">
                        <span>
                          <strong className="d-block">
                            This is your first subscription ? Activate your
                            Account!
                          </strong>{" "}
