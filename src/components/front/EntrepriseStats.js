            ...
            <CardContent className="p-3">
              <div className="d-flex align-items-start">
                <div className="font-weight-bold">
                  ...
                  <span>
                    {props.company.SubscriptionExpirationDate.toString().substr(
                      0,
                      10
                    )}
                  </span>
                  <br />
                  <button className="btn-primary" onClick={UpgradeSubscription}>
            ...
            <List>
              <ListItem className="py-2 d-block">
                ...
                <div className="align-box-row progress-bar--label mt-1 text-muted">
                  ...
                  <div className="ml-auto">
                    {(finishedDeliv(props.company.deliveries) *
                      props.company.deliveries.length) /
                      100}{" "}
                    %
                  </div>
                </div>
