...
const EditProfileCustomerForm = (props) => {
            ...
            <Grid container spacing={9}>
                <Grid item xs={12} lg={12}>
                    <Card className="p-4 mb-4">
                        <div className="font-size-lg font-weight-bold">Edit my infromations</div>
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <FormGroup>
                                        ...
                                        <FormControl
                                            ...
                                            error={formik.errors.cin && formik.touched.cin}
                                            variant="filled">
                                            <FilledInput
                                                id="cin"
                                            ...
                                            {formik.errors.cin && formik.touched.cin && (
                                                <FormHelperText>{formik.errors.cin}</FormHelperText>
                                            )}
                                        </FormControl>
...
const YupSchema = Yup.object ({
    ...
    cin: Yup.number("Cin Code should be a number")
        .required("CIN is Required")
});

export default EditProfileCustomerForm;
