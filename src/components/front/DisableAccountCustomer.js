...
const DisableAccountCustomer = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) =>{
            console.log(values);
            const [res,err] = await queryServerApi("customers/DisableAccount/"+props.id, values,"PUT",false);
...
export default DisableAccountCustomer;
